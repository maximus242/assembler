...
(define (create-section-headers code-size data-size symtab-size strtab-size shstrtab-size dynsym-size dynstr-size rela-size total-dynamic-size dynamic-size)
  (let* ((num-sections 14)
    ...
    ;; .dynsym section
    (set-section-header! headers 6 80 11 2 dynsym-addr dynsym-addr dynsym-size 7 1 8 24)
    ...
    ;; .symtab section
    (set-section-header! headers 11 26 2 0 0 (+ #x2000 code-size data-size) symtab-size 12 1 8 24)
