  ...
  (let* ((program-headers-offset (calculate-program-headers-offset))
         ...
         (unique-symbol-addresses
           (list
             ...
             (cons '.data@LOCAL #x31c0)
             (cons '.bss@LOCAL #x3240)
             ...
             (cons '.symtab@LOCAL #x20d2)
             (cons '.strtab@LOCAL #x2192)
             (cons '.shstrtab@LOCAL #x3f41)
             (cons '.rela.plt@LOCAL #x02f8)
             (cons '.plt.got@LOCAL #x10a0)
             (cons '.got.plt@LOCAL #x31a0)
