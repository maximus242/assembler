  ...
  (let* ((program-headers-offset (calculate-program-headers-offset))
         ...
         (unique-symbol-addresses
           (list
             ...
             (cons '.data@LOCAL #x31e0)
             (cons '.bss@LOCAL #x3280)
             (cons '.rodata@LOCAL #x2000)
             (cons '.dynamic@LOCAL #x3000)
             (cons '.dynsym@LOCAL #x01c8)
             (cons '.dynstr@LOCAL #x0270)
             (cons '.rela.dyn@LOCAL #x02c8)
             (cons '.got@LOCAL #x3120)
             (cons '.plt@LOCAL #x1080)
             (cons '.symtab@LOCAL #x0)
             (cons '.strtab@LOCAL #x0)
             (cons '.shstrtab@LOCAL #x0)
             (cons '.rela.plt@LOCAL #x0340)
             (cons '.plt.got@LOCAL #x10a0)
             (cons '.got.plt@LOCAL #x31c0)
             (cons '.hash@LOCAL #x0358)
             (cons '.gnu.version@LOCAL #x0380)
             (cons '.gnu.version_d@LOCAL #x03a8)
